...
def residual_block(x, filters, conv_num=3, activation='relu'): 
    ...
    x = Add()([x, s])
    x = Activation(activation)(x)
    return MaxPooling2D(pool_size=2, strides=1)(x)
...
model.save('C:/nmb/nmb_data/h5/Conv2D_fm_im4.h5')
...
path = 'C:/nmb/nmb_data/h5/Conv2D_weight_M_imbal4.h5' # 남자 20
...
model.load_weights('C:/nmb/nmb_data/h5/Conv2D_weight_M_imbal4.h5') # 남자 20
...
# Total params: 443,880,282
# Trainable params: 443,880,282
