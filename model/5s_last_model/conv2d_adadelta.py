...
model.save('C:/nmb/nmb_data/h5/5s_last/model_Conv2D_adadelta_mms.h5')
...
tb = TensorBoard(log_dir='C:/nmb/nmb_data/graph/'+ 'Conv2D_adadelta_mms' + "/",histogram_freq=0, write_graph=True, write_images=True)
