...
model.save('C:\\nmb\\nmb_data\\h5\\pre_train\\densenet121_adam.h5')
...
path = 'C:\\nmb\\nmb_data\\h5\\pre_train\\densenet121_adam_1e4.h5'
mc = ModelCheckpoint(path, monitor='val_loss', verbose=1, save_best_only=True)
tb = TensorBoard(log_dir='C:/nmb/nmb_data/graph/'+ 'densenet121_adam_1e4' + "/",histogram_freq=0, write_graph=True, write_images=True)
