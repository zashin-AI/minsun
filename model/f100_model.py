...
f_ds = np.load('C:\\nmb\\nmb_data\\npy\\F100_0_mels.npy')
f_lb = np.load('C:\\nmb\\nmb_data\\npy\\F100_0_mels_label.npy')
m_ds = np.load('C:\\nmb\\nmb_data\\npy\\F100_1_mels.npy')
m_lb = np.load('C:\\nmb\\nmb_data\\npy\\F100_1_mels_label.npy')
# (1073, 20, 216)
# (1073,)
print('f_lb', f_lb)
print('m_lb', m_lb)
...
x_train = x_train.reshape(900,128,862,1)
x_test = x_test.reshape(226,128,862,1)
'''
# 베스트 파라미터 찾기
...
'''
loss: 0.136, accuracy: 0.969, f1score: 0.945
